...
- (void)viewDidLoad
{
    ...
    [button1 setImage:[UIImage imageNamed:@"Back_Icon"] forState:UIControlStateNormal];
    [button1 addTarget:self action:@selector(clickBackBtn) forControlEvents:UIControlEventTouchUpInside];
    ...
    [button2 setImage:[UIImage imageNamed:@"attach_Icon"] forState:UIControlStateNormal];
    [button2 addTarget:self action:@selector(clickAttachBtn) forControlEvents:UIControlEventTouchUpInside];
